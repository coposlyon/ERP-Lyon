# Termo de Entrega e Encerramento do Projeto

| Referência | |
|---|---|
| Contrato | Prestação de Serviços de Desenvolvimento de Software — ERP Lyon Copos, assinado eletronicamente em 11/06/2026 |
| Contratante | CLODOALDO FARINHA e LAION CESAR FARINHA — CLODOALDO FARINHA (LYON COPOS), CNPJ 40.899.894/0001-18 |
| Contratado | PABLO FLORES SANTAREM, CPF 051.977.620-80 |
| Data da entrega | 15/09/2026 |

---

## 1. Declaração de entrega

O CONTRATADO declara que, nesta data, **entregou à CONTRATANTE todo o objeto do contrato**, conforme o quadro abaixo.

| Cl. | Obrigação do contrato | Entregue |
|---|---|---|
| 1ª | ERP exclusivo em nuvem | sistema em produção em https://lyoncopos.online |
...
| 2ª | portal do cliente | `/acompanhar` — linha do tempo, aprovação de arte, comprovante, fotos, 2ª via e retirada |
| 2ª | rastreamento de pedidos | régua de 28 status, código de rastreio e Total Express |
| 2ª | integração bancária | contas bancárias, conciliação, cobrança e confirmação PIX; boleto/CNAB e gateway PIX com código pronto |
| 2ª | engenharia de custos | Maquinários, Computadores e TI, Insumos, Despesas Fixas e Variáveis, Formação de Preço, Tabela de Preços |
| 2ª | logística | coleta, retirada, trânsito, entrega, expedição, transportadoras, caixas e frete |
...
**PABLO FLORES SANTAREM**

CPF 051.977.620-80 — CONTRATADO
