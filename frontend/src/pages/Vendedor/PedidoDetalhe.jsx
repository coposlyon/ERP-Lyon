              ...
              {(p.documentos || []).map(doc => (
                <button key={doc.key}
                  ...
                  onClick={() => {
                    ...
                    // O pedido em PDF é uma TELA, e não um download cego: o
                    // vendedor confere o que vai sair antes de mandar. As
                    // três opções (imprimir, ver a arte, baixar) já estão
                    // no topo dela — perguntar aqui antes era um clique a
                    // mais para chegar na mesma escolha.
