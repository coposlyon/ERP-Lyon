...
router.get('/product/:id', async (req, res) => {
  try {
    ...
    const lines = [
      ...
      { key: 'adicionais',    label: 'Adicionais que já vêm no preço (borda, tampa, canudo)',
        value: adic.custo, origin: 'Produtos › Sub-Produtos e Bordas', link: '/products?secao=subprodutos',
  ...
  try {
    ...
    const lines = [
      ...
      { key: 'adicionais', label: 'Adicionais que já vêm no preço', value: adic.custo,
        origin: 'Produtos › Sub-Produtos e Bordas', link: '/products?secao=subprodutos',
